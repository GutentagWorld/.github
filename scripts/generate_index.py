...
def ci_badge(repo_name: str) -> str:
    url = f'https://github.com/GutentagWorld/{repo_name}/actions/workflows/ci.yml'
    badge = f'https://github.com/GutentagWorld/{repo_name}/actions/workflows/ci.yml/badge.svg'
    return f'[![CI]({badge})]({url})'
...
def generate_readme(existing: set[str]) -> str:
    ...
    lines.append('')
    lines.append(
        '_This file is auto-generated by [scripts/generate_index.py](scripts/generate_index.py). '
        'It updates weekly via GitHub Actions._'
    )
    lines.append('')
